...
var sqlInstance = "10.245.39.101\\SQLEXPRESS2014"; // SQL instance where to insert the data (FL01)
var sqlUserName = "PSIM";				// SQL login
var sqlPassword = "\"YSPW7509-sywj!#O%&\"";	// SQL password
...
if (Event.SourceType == "INC_SERVER" && Event.Action == "EVENT") {
    ...
    if (WorksBase64_length >= 2) { // Process the script ONLY when operator done at least one step in the workflow, ignore rest of the events. This can be achieved by checking the length of WorksBase64 array
        ...
        //var step_timestampR24 = getTimestampFromStep(step_raw);	// manualR24_timestamp
        ...
        //DebugLogString("Catching operator steps: edit_text is "+edit_text+", child_control_id_0 is "+child_control_id_0+", child_control_id_1 is "+child_control_id_1+", child_control_id_2 is "+child_control_id_2+", child_control_id_3 is "+child_control_id_3+".");
        //DebugLogString("Catching operator steps: full step is: "+step_raw);
        //DebugLogString("Catching operator steps: source event timestamp is: "+source_timestamp);
